  ...
  <div>
    <el-form :inline="true" :model="query" class="query-form" size="mini">
      ...
      <el-form-item>
        <el-button-group>
          ...
          <el-button type="primary">{{total}}</el-button>
        </el-button-group>
      </el-form-item>
    </el-form>
      ...
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form
            ...
            v-if="props.row.logs.length"
          >
            <el-form-item :label="v.nickname || '匿名者'" v-for="(v,k) in props.row.logs" :key="k">
              <span>{{ v.content }}</span>
            </el-form-item>
          </el-form>
          <el-alert v-else title="该问题暂时没有日志" type="warning" :closable="false"></el-alert>
        </template>
      </el-table-column>
      <el-table-column label="编号" type="index"></el-table-column>
      <el-table-column label="问题内容" prop="content"></el-table-column>
      <el-table-column label="优先级" sortable prop="weigh"></el-table-column>
      <el-table-column label="严重程度" sortable prop="serious"></el-table-column>
      ...
      <el-table-column label="状态">
        <template slot-scope="scope">
          <el-tag
            ...
            @click="handleStatusForm(scope.$index, scope.row)"
          >
            {{
    ...
    >
      <el-form :model="formData" :rules="formRules" ref="dataForm" :disabled="checkData">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="问题类型" prop="type_id">
              <el-select v-model="formData.type_id" placeholder="请选择问题类型">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="优先级别" prop="weigh">
              <el-input-number v-model="formData.weigh" :min="0"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="严重程度" prop="serious">
              <el-input-number v-model="formData.serious" :min="0"></el-input-number>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-form-item label="改进方案" prop="programme">
          <el-input v-model="formData.programme" auto-complete="off"></el-input>
        </el-form-item>
    ...
    >
      <el-form :model="formData" :rules="formRules" ref="dataForm">
        <el-form-item label="日志内容">
          <el-input v-model="log.content" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click.native="hideLogForm">取消</el-button>
        <el-button type="primary" @click.native="logFormSubmit()" :loading="formLoading">提交</el-button>
      </div>
    </el-dialog>
    <!-- 图片显示 -->
    ...
    <el-dialog :visible.sync="statusFormVisible" title="修改状态">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click.native="statusFormSubmit()" :loading="formLoading">提交</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    logFormSubmit() {
      ...
      problemLog(this.log).then(response => {
    ...
    statusFormSubmit() {
      ...
      problemSave(data, "edit").then(response => {
        this.formLoading = false;
        if (response.code) {
          this.$message.error(response.message);
          return false;
